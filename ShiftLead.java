public class ShiftLead extends Employee {
     ...
     *                  Password must be a number of exactly 6 digits
     ...
     *                  special characters. HOURLY_WAGE will be set to 21.
     * 
     * @param first
     * @param last
     * @param password
     */
    public ShiftLead(String first, String last, String password){
        super(first, last, password, 21);
    }
     ...
     *                  Specified employee. HOURLY_WAGE will be set to 21.
     * 
     * @param first
     * @param last
     * @param password
     */
    public ShiftLead(Employee other){
